...
export const StepTwo = () => {
    ...
    return  (
        <div className="identification"  onSubmit={(e) => onSubmit(e)}>
            ...
            <form className='identification__form'  onSubmit={(e) => handleSubmit(onSubmit(e))} data-test-id='register-form'>
                ...
                {inpurErrorOne && <p  data-test-id='hint' className='identification__form-help' style={{color:' #F42C4F'}}> Поле не может быть пустым</p>}
                ...
                {inpurErrorTwo && <p data-test-id='hint' className='identification__form-help' style={{color:' #F42C4F'}}> Поле не может быть пустым</p>}
